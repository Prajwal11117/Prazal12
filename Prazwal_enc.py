...
╔═══════════════════════════════════════════════════════════════════════════╗
║  {0}WONER      : PRAJWAL EXO                                                   ║
║  {1}RULL3X     : PRAJWAL XD HERE                                      ║
║  {1}FACEBOK    : PRAJWAL DON                                         ║
║  {2}RULS       : MULTI TOKEN CONVO                                           ║
║  {3}GITHUB     : PRAJWAL                                                ║ 
║  {1}WH9TS9P    : +97797704678326                                        ║
╚═══════════════════════════════════════════════════════════════════════════╝
    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.GREEN + f"└────────────────────────────────────────────────────────────────────┘\n")
                print(Fore.YELLOW + "\033[1;37m<<======== MADE BYY PRAJWAL-EXOFORT😈🩷 ======>>")
                print("\n" + ("─" * 80) + "\n")
            except requests.exceptions.RequestException:
...
def main():
    ...
    pastebin_url = "https://pastebin.com/raw/wXyp08c4"  # URL of the pastebin containing the password
